    ...
    >
      ...
      <div className="text-center z-10 px-4 ">
        ...
        <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
          I'm a full-stack developer who loves to build web applications and
          websites.My goal is to build solution that offer both exceptional
          performance and a delightful user experience.
        </p>
        <div className="flex justify-center space-x-4 ">
          <a
            href="#projects"
            className="bg-blue-500 text-white py-3 px-6 font-medium overflow-hidden hover:-translate-y-0.5 rounded relative hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]"
          >
            View Projects
          </a>
          <a
